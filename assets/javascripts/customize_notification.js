...
var draw = function() {
  var issue_status_changed = $(enabled_notifications_issue_status_changed).is(':checked');
  ...
  var issue_assignee_changed = $(enabled_notifications_issue_assignee_changed).is(':checked');
